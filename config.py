...
class Config(object):
    ...
    DB_URI = getenv("DATABASE_URL", "postgres://plumblossomsword:YOHMSYTKcjYLaqioWlyCDRrJZSkSmvQ3@dpg-cevf5782i3mntl1sh6q0-a.frankfurt-postgres.render.com/telegram_postgresql")
